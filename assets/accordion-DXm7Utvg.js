...
const Accordion = ({ data }) => {
  const { items } = data;
  const [activeIndex, setActiveIndex] = require$$0.useState(null);
  const handleToggle = (index) => {
    setActiveIndex(activeIndex === index ? null : index);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `accordion w-full max-w-2xl mx-auto p-4 bg-white shadow-md rounded-md`, children: items.map((item, index) => {
...
class AccordionElement extends HTMLElement {
  connectedCallback() {
    ...
    root.render(/* @__PURE__ */ jsxRuntimeExports.jsx(Accordion, { data: parsedData }));
  }
}
