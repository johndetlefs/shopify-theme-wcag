var n, l$1, u$2, i$1, o$1, r$1, f$2, e$1, c$1, s$1, h$1 = {}, v$1 = [], p$1 = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i, y = Array.isArray;
function d$1(n2, l2) {
...
function M() {
  ...
  for (i$1.sort(f$2); n2 = i$1.shift(); ) n2.__d && (u2 = i$1.length, o2 = void 0, e2 = (r2 = (t2 = n2).__v).__e, c2 = [], s2 = [], t2.__P && ((o2 = d$1({}, r2)).__v = r2.__v + 1, l$1.vnode && l$1.vnode(o2), O(t2.__P, o2, r2, t2.__n, t2.__P.namespaceURI, 32 & r2.__u ? [e2] : null, c2, null == e2 ? x(r2) : e2, !!(32 & r2.__u), s2), o2.__v = r2.__v, o2.__.__k[o2.__i] = o2, j$1(c2, o2, s2), o2.__e != e2 && C(o2)), i$1.length > u2 && i$1.sort(f$2));
  M.__r = 0;
}
...
function z$1(u2, t2, i2, o2, r2, f2, e2, c2, s2) {
  ...
  if (null === C2) b2 === k2 || c2 && u2.data === k2 || (u2.data = k2);
    ...
    else if (p2 && (u2.innerHTML = ""), P(u2, y(d2) ? d2 : [d2], t2, i2, o2, "foreignObject" === C2 ? "http://www.w3.org/1999/xhtml" : r2, f2, e2, f2 ? f2[0] : i2.__k && x(i2, 0), c2, s2), null != f2) for (a2 = f2.length; a2--; ) w$1(f2[a2]);
...
const Accordion = (props) => {
  ...
  return /* @__PURE__ */ u$1("div", { className: `accordion w-full mx-auto p-4 bg-white`, children: items.map((item, index) => {
    return /* @__PURE__ */ u$1("div", { className: `accordion-item mb-4`, children: [
      /* @__PURE__ */ u$1(
        "button",
        {
          ...
          children: [
            item.title,
            /* @__PURE__ */ u$1("i", { className: `${activeIndex === index ? "bi-chevron-up" : "bi-chevron-down"} text-white font-bold` })
          ]
        }
      ),
      /* @__PURE__ */ u$1(
        "div",
        {
          ...
          children: /* @__PURE__ */ u$1("p", { className: `p-4 bg-gray-100 rounded-sm mt-2 whitespace-pre-wrap`, children: item.content })
        }
      )
    ] }, index);
  }) });
...
class AccordionElement extends BaseComponent {
  connectedCallback() {
    ...
    B$1(/* @__PURE__ */ u$1(Accordion, { data: parsedData }), container);
  }
}
