...
const Accordion = ({ data }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `accordion w-full max-w-2xl mx-auto p-4 bg-white shadow-md rounded-md`, children: items.map((item, index2) => {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `accordion-item mb-4`, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          className: `accordion-content overflow-hidden transition-max-height duration-300 ease-in-out ${activeIndex === index2 ? "max-h-96" : "max-h-0"}`,
          hidden: activeIndex !== index2,
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `p-4 bg-gray-100 rounded-md mt-2 whitespace-pre-wrap`, children: item.content })
        }
      )
    ] }, index2);
  }) });
...
class AccordionElement extends HTMLElement {
  connectedCallback() {
    ...
    style2.textContent = tailwindStyles;
