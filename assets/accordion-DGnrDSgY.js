...
const Accordion = (props) => {
  ...
  return /* @__PURE__ */ u$1("div", { className: `accordion w-full max-w-2xl mx-auto p-4 bg-white shadow-md rounded-md`, children: items.map((item, index) => {
    return /* @__PURE__ */ u$1("div", { className: `accordion-item mb-4`, children: [
      ...
      /* @__PURE__ */ u$1(
        "div",
        {
          ...
          children: /* @__PURE__ */ u$1("p", { className: `p-4 bg-gray-100 rounded-md mt-2 whitespace-pre-wrap`, children: item.content })
        }
      )
    ] }, index);
  }) });
